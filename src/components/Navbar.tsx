    ...
    <header className="border-b border-black/10 dark:border-white/10 bg-white/90 dark:bg-gray-900/90 backdrop-blur-md supports-[backdrop-filter]:bg-white/80 sticky top-0 z-50 shadow-sm">
      <div className="mx-auto max-w-7xl px-4 sm:px-6">
        <div className="flex h-20 items-center justify-between">
            ...
            <Link href="/" className="flex items-center group" aria-label="The Rajkot Today">
              <div className="flex flex-col">
                <div className="flex items-center whitespace-nowrap leading-none">
                  <span className="text-3xl sm:text-4xl font-extrabold tracking-tight text-gray-900 dark:text-white group-hover:text-red-600 dark:group-hover:text-red-400 transition-colors">The Rajkot</span>
                  <span className="ml-2 sm:ml-3 text-[11px] sm:text-xs font-bold uppercase text-white bg-red-600 px-2.5 py-1 rounded-full shadow-sm">Today</span>
                </div>
                <div className="text-[9px] sm:text-[10px] text-gray-600 dark:text-gray-400 font-medium tracking-wide uppercase mt-1 sm:mt-1.5 whitespace-nowrap">
          ...
          <div className="flex items-center gap-3">
            <Link href="/search" className="inline-flex items-center gap-2 px-4 py-2 bg-gray-100 dark:bg-gray-800 rounded-full text-sm font-medium text-gray-700 dark:text-gray-300 hover:bg-gray-200 dark:hover:bg-gray-700 transition-colors">
          ...
          <div className="flex flex-wrap gap-x-2 gap-y-2 text-sm">
            {CATEGORIES.map((c) => (
              <Link 
                key={c.slug} 
                href={`/category/${c.slug}`} 
                className="px-3 py-2 text-gray-700 dark:text-gray-300 hover:text-red-600 dark:hover:text-red-400 hover:bg-gray-100 dark:hover:bg-gray-800 rounded-md transition-colors"
              >
